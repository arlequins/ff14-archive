...
<c:url value="/board/${target}/" var="paging" />
<t:layout_ng tab="${target}">
	<div ng-cloak ng-controller="DetailController">
			...
			<form>
				<div class="row">
					<div class="large-10 columns">
						<input type="search" name="q" placeholder="${text['common.menu.search']}" value="${question}">
					</div>
					<div class="large-2 columns">
						<input type="submit" value="${text['common.menu.search']}" class="expanded button"></input>
					</div>
				</div>
			</form>
			<!-- End Inner Search -->
		...
		<div class="column row" id="content">
			...
			<div class="large-12 columns mgb20" ng-show="switcher.status == -1">
				<h3>${targetName}</h3>
				<table class="outerboard mgb20">
					<thead>
						<tr>
							<th width="10%">key</th>
							<th width="15%">date</th>
	...
	var requestUrl = "/ff14/board/ff14kboard";
